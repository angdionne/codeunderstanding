...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2018 at 6:58 PM
...
CREATE TABLE `food_category` (
  ...
  `food_cat_image` varchar(255) NOT NULL,
...
(6, 8, 'Chicken Corn Soup', 'lunch.png', ' Sausage, pepperoni, mushrooms, olives, peppers, and onions are great on a pizza! You can add or subtract what you want to create your favorite Supreme Pizza.\r\n '),
(8, 7, 'Chicken Corn Soup (s)', 'p1.jpg', ' Looking for a healthy option? served with your choice of vegetables.'),
(9, 7, 'Hot and Sour Soup (s)', 'cuisine8.jpg', 'Looking for a healthy option? served with your choice of vegetables.'),
(10, 8, 'Spinach-Artichoke Dip', 'p3.jpg', 'A blend of spinach, artichokes and five cheeses served warm with our NEW house-made pasta chips\r\n'),
...
(12, 5, 'Grilled Chicken & Havarti Cheese', 'p2.jpg', 'Crunchy Tortilla chips served with your choice of salsa! Get it the way you like with the \"make your own\" tac\r\n'),
(13, 5, 'Wood flourless Chocolate Waffle', 'cuisine7.jpg', ' with vanilla ice cream & toasted almonds '),
(14, 5, 'Chicken Dhum Seekh', 'p1.jpg', 'Crunchy Tortilla chips served with your choice of salsa! Get it the way you like with the \"make your own\" taco.\r\n'),
...
(16, 6, 'Fish Tikka', 'imgpsh_fullsize.jpg', 'Crunchy Tortilla chips served with your choice of salsa! Get it the way you like with the \"make your own\" taco.\r\n'),
...
CREATE TABLE `gifts` (
  ...
  `gift_amount` varchar(244) NOT NULL,
  `gift_email` varchar(244) NOT NULL,
  `gift_recipient` varchar(244) NOT NULL,
...
INSERT INTO `gifts` (`gift_id`, `gift_amount`, `gift_email`, `gift_recipient`, `personal_message`, `datetime`) VALUES
(0, '40', 'angela@gmail.com', 'ssd', 'ertger', '2018-10-25 16:02:12');
...
(5, 'Topolino', 1, 'lahore', 'ddd', '', 'Knowledge Curve.png', '10:30:00', '17:00:00', 'service-banner.jpg'),
(6, 'bundu khan', 1, 'pakges MAll', 'aaaaa', '', 'tech banner.png', '00:00:00', '00:00:00', 'banner.jpg'),
...
(12, 'Great American Buffet', 1, 'qww', '121212', '', '1499845571Splash_tours_mobile-28.jpg', '09:45:00', '23:45:00', 'service-banner.jpg'),
(13, 'Olive Garden', 0, 'aaaa', 'aaaaa', '', '1499845686techknow-curve.png', '10:00:00', '23:00:00', 'service-banner.jpg');
...
(5, 'Grilled Burger', 9, 'aadfaf', 400, 2, 0),
(7, 'Chicken', 5, 'yummy to my tummy', 340, 3, 0),
(8, 'Soup', 5, 'yummy to my tummy', 200, 3, 0),
(9, 'Desi Karahi', 7, 'yummy to my tummy', 122, 5, 2),
...
(2, 'jane@gmail.com', '2017-07-18 13:57:28'),
(3, 'amad@gmail.com', '2017-07-18 13:58:04'),
(4, 'oladopo@gmail.com', '2017-07-18 14:00:06'),
(5, 'tinamarie@gmail.com', '2017-07-29 07:31:12');
...
(47, '', NULL, '', 726, 'cash', '', 0, 's dfsfd s f ', 2, 5, '', '2017-08-16 12:00 PM', 'new', '', '', 'now', 'paid'),
...
--
-- Indexes for table `food_subcat`
--
ALTER TABLE `food_subcat`
  ADD PRIMARY KEY (`f_subcat_id`);
...
ALTER TABLE `menu_extras`
  ADD PRIMARY KEY (`m_extra_id`);

--
-- Indexes for table `menu_gallery`
--
ALTER TABLE `menu_gallery`
...
--
ALTER TABLE `food_category`
  MODIFY `food_cat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `food_subcat`
--
ALTER TABLE `food_subcat`
  MODIFY `f_subcat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `kitchen`
  MODIFY `kitchen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `menu_extras`
  MODIFY `m_extra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `menu_gallery`
--
ALTER TABLE `menu_gallery`
  MODIFY `menuimage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
