...
<!--          <li class="treeview">-->
<!--              <a href="--><?php //echo base_url();?><!--dashboard/kitchen">-->
...
<!--          </li>-->
          ...
          <!--<li class="treeview">
              <a href="<?php echo base_url();?>dashboard/food_cat">
          ...
          <li class="treeview">
              <a href="<?php echo base_url();?>dashboard/food_subcat">
                  <i class="fa fa-circle"></i>
          ...
          <li class="treeview">
              <a href="<?php echo base_url();?>dashboard/menu_extras">
                  <i class="fa fa-cutlery"></i>
