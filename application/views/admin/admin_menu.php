...
<div class="wrapper">
 ...
 <a style="margin-left:15px;margin-top:15px;" href="#" <button class="btn btn-success" type="button">Add Menu</button></a>
                                ...
                                {?>
                                    <tr>
                                     ...
                                     <!--   <td><img src="<?php // echo base_url();?>assets/uploads/images/<?php // echo $item->menu_gallery;?> " class="img-rounded" height="30px" width="40px"></td>
                                        ...
                                        <td><a style="color: #3c8dbc;font-size:12px!important;" href="#">Edit</a> /
<!--<a style="color: green;font-size:12px!important; " href="<?php// echo base_url();?>dashboard/editMenuImages/<?php// echo $item->menu_id;?>">Images</a>
                                         ...
                                         <a style="color: red;font-size:12px!important;"onClick="return doconfirm();"  href="#">Delete</a> </td>
                                    </tr>
                                <?php }?>
                                </tbody>
                            </table>
