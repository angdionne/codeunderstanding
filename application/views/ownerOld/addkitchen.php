    ...
    <div class="content-wrapper" >
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form  method="POST" action="<?php echo base_url();?>index.php/dashboard/newKitchen" enctype="multipart/form-data"  class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="kitchenname" class="col-sm-3 control-label">Kitchen Name</label>

                            <div class="col-sm-7">
                                <input type="input" name="kitchenname" class="form-control" id="kitchenname" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                            <input type="kitchenaddress" name="kitchenaddress" class="form-control" id="kitchenaddress" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="kitchenlocation" name="kitchenlocation" class="form-control" id="kitchenlocation" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                              <input id="file" type="file" name="file" class="form-control" accept=".jpg ,.jpeg,.png" required=""> 
                                        </div>
                            </div>
