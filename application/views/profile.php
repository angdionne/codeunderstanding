                ...
                <form  method="POST" action="<?php echo base_url();?>index.php/dashboard/updateProfile" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="email" name="email" class="form-control" id="inputEmail3" value="<?php echo $profile->contact_email ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="name" name="name" class="form-control" id="inputEmail3" value="<?php echo $profile->contact_name ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password"  name="password" class="form-control" id="inputPassword3" value=" <?php echo $profile->contact_password ?>">
                            </div>
                        </div>
                        <div class="form-group">
